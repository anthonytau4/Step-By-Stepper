...
(function () {
  ...
  function renderStudioFullPage(theme) {
    ...
    var html = '';
    html += '<style>';
    html += '.studio-full-shell{min-height:78vh;max-width:100%;overflow:hidden;}';
    ...
    html += '.studio-full-layout{display:grid;grid-template-columns:minmax(0,320px) minmax(0,1fr);min-height:68vh;}';
    html += '.studio-full-main{min-width:0;}';
    ...
    html += '.studio-full-layout{grid-template-columns:minmax(0,1fr);}';
    html += '.studio-full-aside{border-right:none!important;border-bottom:1px solid ' + (theme.dark ? '#2d3748' : '#d1d5db') + ';}';
    html += '.studio-full-header-actions{width:100%;}';
    html += '.studio-full-header-actions button{flex:1 1 160px;}';
    html += '.studio-full-mixer{grid-template-columns:minmax(0,1fr);}';
    html += '}';
    html += '</style>';
