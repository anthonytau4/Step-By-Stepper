...
(function(){
  ...
  const EXTRA_NOTES = [
    'New: Featured Choreo now includes the first full Step by Stepper showcase sheet with a bronze First Dance badge and the full preview-style write-up built right into the tab.',
