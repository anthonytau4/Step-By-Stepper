...
(function(){
  ...
  const EXTRA_NOTES = [
    "New: Featured Choreo is now its own separate shelf instead of showing your saved builds, and My Saved Dances now gives computer users a Gmail backup button that opens in a new tab.",
