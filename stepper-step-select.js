...
(function () {
  ...
  function injectStyles() {
    ...
    s.textContent = [
      ...
      '  z-index: 9990; width: 440px; max-width: calc(100vw - 24px);',
      ...
      '  width: 100%; padding: 7px 10px; border-radius: 8px; border: 1px solid #d1d5db;',
      '  font-size: 14px; outline: none; background: #fff; color: #111827;',
      ...
      '  color: #9ca3af; line-height: 1; padding: 2px 6px;',
      '}',
